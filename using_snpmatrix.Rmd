...
snp_matrix1 <- read.csv("Processed_SNP_matrices/chr1.csv", header = T)
...
loci <- read.csv("Processed_SNP_matrices/chr1_loci.csv", header = T)
loci <- loci[,2:3]
...
colours <- c("darkslategrey","darkcyan")
