...
```
# First try. Detailing issued faced for future reference.
# Working workflow = pcadatp_workflow.Rmd
...
So the SRR isolates should all be labeled as pre-drought..WAI324, 326 and 329 come from the Wagga 2001 field population, which I would also classify as “pre-drought” although I know this is borderline

delete  WAI327  WAI328
