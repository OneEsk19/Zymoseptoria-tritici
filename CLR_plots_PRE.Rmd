...
```{r}
preplot2 <- plot_grid(pre1, pre2, pre3, pre4, pre5, pre6, pre7, pre8, pre9, pre10, pre11, pre12, pre13, ncol = 13, nrow = 1, rel_widths = c(6.3, 4.1, 4.0, 3, 3, 2.6, 3.1, 2.5, 2.2, 2, 1.8, 1.5, 1.2))
```

```{r}
ggsave(filename = "./IMGS/WG_CLR_pre.png", plot = preplot2, device = "png", width = 50, height = 4, units = "cm")
```
