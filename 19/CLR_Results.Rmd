...
See what the upper and lower limits to the data are, extract the top 10% and write to file
```{r}
range(postCLR$Likelihood)
# 0.000 1553.731
highest <- postCLR[postCLR$Likelihood>=1400,]
```

```{r}
write.csv(highest, "./data_sheets/CLR_post_top10pc.csv", quote = F, row.names = F)
