...
```{r}
postplot2 <- plot_grid(post1, post2, post3, post4, post5, post6, post7, post8, post9, post10, post11, post12, post13, ncol = 13, nrow = 1, rel_widths = c(6.3, 4.1, 4.0, 3, 3, 2.6, 3.1, 2.5, 2.2, 2, 1.8, 1.5, 1.2))
```

```{r}
ggsave(filename = "./IMGS/WG_CLR_post.png", plot = postplot2, device = "png", width = 50, height = 4, units = "cm")
```
